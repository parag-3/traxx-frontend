...
export function DateNavigator({ selectedDate, onSelectDate, refreshTrigger }: DateNavigatorProps) {
  ...
  return (
    <div className="bg-white/80 dark:bg-[#11141d]/80 backdrop-blur-md border border-zinc-200/70 dark:border-white/[0.06] rounded-2xl p-3 sm:p-3.5 shadow-xs space-y-2.5">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 px-0.5">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <div className="relative">
            ...
            <button
              type="button"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-zinc-100/80 dark:bg-[#151926] hover:bg-zinc-200/80 dark:hover:bg-[#1c2234] border border-zinc-200/60 dark:border-white/[0.06] text-zinc-900 dark:text-white transition-colors cursor-pointer text-xs font-semibold"
            >
          ...
          <div className="flex items-center bg-zinc-100/80 dark:bg-[#151926] border border-zinc-200/60 dark:border-white/[0.06] rounded-xl p-0.5">
            <button
              type="button"
              onClick={() => handleShiftDays(-1)}
              className="w-6 h-6 rounded-lg flex items-center justify-center text-zinc-500 hover:text-zinc-900 dark:hover:text-white hover:bg-white dark:hover:bg-[#1e2334] transition-colors cursor-pointer"
              title="Previous Day"
            >
        ...
        <div className="flex items-center gap-1.5 text-xs">
          {!isToday ? (
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold shadow-xs transition-all cursor-pointer"
            ...
            <span className="text-[11px] font-semibold text-blue-600 dark:text-cyan-400 bg-blue-50 dark:bg-blue-950/40 px-2 py-0.5 rounded-lg border border-blue-200/50 dark:border-blue-900/40">
              Today
            </span>
          )}

          {/* Week Shift */}
          <div className="flex items-center gap-0.5 text-zinc-400 text-[11px]">
            <button
              type="button"
              onClick={() => handleShiftWeek(-1)}
              className="px-2 py-1 rounded-lg hover:bg-zinc-100 dark:hover:bg-[#151926] hover:text-zinc-200 transition-colors cursor-pointer"
              title="Previous Week"
            >
              &larr; Prev
            </button>
      ...
      {/* Sleek Minimal 7-Day Week Strip */}
        ...
        {weekDays.map((day) => {
          ...
          return (
            <button
              ...
              className={`group relative h-14 sm:h-16 rounded-xl flex flex-col justify-between p-1.5 sm:p-2 transition-all duration-150 text-center border cursor-pointer ${
                styles.card
