...
export default function Home() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center bg-zinc-50 dark:bg-black font-sans text-zinc-500">
        Loading...
      </div>
    );
  }
  ...
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center bg-zinc-50 font-sans dark:bg-black p-4">
      <main className="flex flex-col items-center gap-6 p-8 bg-white dark:bg-zinc-900 shadow-xl rounded-2xl border border-zinc-200 dark:border-zinc-800 transition-all w-full max-w-lg">
        {user ? (
          <div className="flex flex-col items-center gap-4 w-full">
            {user.picture && (
              // eslint-disable-next-line @next/next/no-img-element
              <img src={user.picture} alt="Profile" className="w-20 h-20 rounded-full border-4 border-zinc-100 dark:border-zinc-800 shadow-sm" />
            )}
        ...
        <div className="mt-6 w-full pt-6 border-t border-zinc-200 dark:border-zinc-800 text-center">
